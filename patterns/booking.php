...
<section class="wp-block-group h-section tod-booking" id="contact">
	...
	<div class="wp-block-buttons h-cta-row tod-reveal">
		...
		<div class="wp-block-button h-btn-ghost-wp"><a class="wp-block-button__link wp-element-button" href="https://soundcloud.com/glittawicca">SoundCloud</a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
