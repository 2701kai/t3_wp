 ...
 */
?>
<!-- wp:group {"tagName":"section","className":"h-finale","layout":{"type":"default"}} -->
<section class="wp-block-group h-finale">
	...
	<div class="wp-block-group h-finale-inner">
		...
		<h2 class="wp-block-heading h-finale-title tod-split">See you at sunrise</h2>
		<!-- /wp:heading -->
