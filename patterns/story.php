 ...
 */
?>
<!-- wp:group {"tagName":"section","anchor":"story","className":"h-section","layout":{"type":"default"}} -->
<section class="wp-block-group h-section" id="story">
	...
	<!-- wp:list {"className":"h-genres tod-reveal"} -->
	<ul class="wp-block-list h-genres tod-reveal">
		<!-- wp:list-item -->
		<li>House</li>
		<!-- /wp:list-item -->
