 ...
 */
?>
<!-- wp:group {"tagName":"section","className":"tod-artist","layout":{"type":"default"}} -->
<section class="wp-block-group tod-artist">
	<!-- wp:html -->
	<div class="tod-atmo"></div>
	<div class="h-laser h-laser-a"></div>
	<div class="h-laser h-laser-b"></div>
	<div class="h-laser h-laser-c"></div>
	<!-- /wp:html -->

	<!-- wp:group {"className":"tod-artist-main","layout":{"type":"default"}} -->
	<div class="wp-block-group tod-artist-main">
		<!-- wp:paragraph {"className":"tod-artist-kicker"} -->
		<p class="tod-artist-kicker">DJ · TiTis on Decks · Algarve</p>
		<!-- /wp:paragraph -->

		<!-- wp:heading {"level":1,"className":"tod-artist-title tod-split"} -->
		<h1 class="wp-block-heading tod-artist-title tod-split">Glitta</h1>
		<!-- /wp:heading -->
